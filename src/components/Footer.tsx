  ...
  return (
    <footer className="relative z-10 border-t border-border/50 bg-background/50 backdrop-blur-sm">
      <div className="max-w-6xl mx-auto px-6 py-12">
        {/* Discord CTA */}
        <div className="pb-10 mb-10 border-b border-border/50 flex flex-col items-center text-center gap-3">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-[hsl(235,86%,65%)] hover:bg-[hsl(235,86%,58%)] text-primary-foreground text-sm font-semibold transition-colors"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              Lightning fast cryptocurrency exchange. Non-custodial, no KYC.
            </p>
          </div>
